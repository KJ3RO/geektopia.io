    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From AI Development to Star Wars themed keyboards, we aim to provide a home for all geeks.
        </p>
      </div>
...
export const SkeletonTwo = () => {
  const images = [geektopia, geektopia, geektopia, geektopia];
...
export const Globe = ({ className }: { className?: string }) => {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      markers: [
        // longitude latitude
        { location: [33.3786, 126.5662], size: 0.1 },
        { location: [36.7783, -119.4179], size: 0.03 },
        { location: [41.878, -93.0977], size: 0.05 },
      ],
      onRender: (state) => {
